...
class ResnetBlock(nn.Module):
    def __init__(self, *, in_channels, out_channels=None, conv_shortcut=False,
                 dropout, temb_channels=512, padding_mode="circular"):
        super().__init__()
    ...
    def __init__(self, config):
        ...
        for i_level in range(self.num_resolutions):
            ...
            if i_level != self.num_resolutions-1:
                down.downsample = Downsample(block_in, resamp_with_conv, padding_mode=config.model.padding_mode)
        ...
        for i_level in reversed(range(self.num_resolutions)):
            ...
            up.attn = attn
            if i_level != 0:
                up.upsample = Upsample(block_in, resamp_with_conv, padding_mode=config.model.padding_mode)
                curr_res = curr_res * 2
